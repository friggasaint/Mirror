public class Gleitpunktzahl {
	...
	public Gleitpunktzahl add(Gleitpunktzahl r) {
		...
		denormalisiere(summand1, summand2);						// denormalisiere betragsm�ssig gr��ere Zahl
		if(summand1.vorzeichen & summand2.vorzeichen){			// beide negativ
			...
			if(summand1.toDouble() >= summand2.toDouble()){		// entscheide welcher Summand Gr��er ist
				
			}
			
		}
		gpz.exponent = summand1.exponent;
		gpz.normalisiere(5);									// einfach mal 5 gew�hlt, nirgends steht welche Anzahl gew�hlt werden sollt(zumindest hab ich nix gelesen)
