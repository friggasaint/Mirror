public class Gleitpunktzahl {
	 ...
	 * Update by
	 * 
	 * @author JÃ¼rgen BrÃ¤ckle (braeckle@in.tum.de)
	...
	/** Gibt das Objekt in binÃ¤rer Darstellung aus */
	 ...
	 */
	/** Liefert true, wenn die Gleitpunktzahl die Null reprÃ¤sentiert */
	...
	/**
	 * Gibt eine Gleitpunktzahl mit dem Wert Null zurÃ¼ck
	 */
	...
	/**
	 * Gibt eine Gleitpunktzahl mit dem Wert NaN zurÃ¼ck
	 */
	...
	/**
	 * Gibt eine Gleitpunktzahl mit dem Wert plus Unendlich zurÃ¼ck
	 */
	...
	/**
	 * Gibt eine Gleitpunktzahl mit dem Wert minus Unendlich zurÃ¼ck
	 */
	...
	public void normalisiere(int anzNachkommastellen) {
		...
		if (exp + expOffset >= maxExponent) { /* Exponent zu groÃŸ -> Unendlich */
	...
	public static void denormalisiere(Gleitpunktzahl a, Gleitpunktzahl b) {
		...
		/* Beide Mantissenfelder um expDiff vergroeÃŸern */
		a.mantisse.erweitern(expDiff);
		b.mantisse.erweitern(expDiff);

		/*
		 * Exponent der groeÃŸeren Zahl anpassen und entsprechende Mantisse nach
		 * links shiften
		 */
	 ...
	 * die betragsmaeÃŸig groeÃŸere Zahl denormalisiert und die Mantissen beider
